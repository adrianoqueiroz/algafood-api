...
public class LinksGenerator {
    ...
    public Link linkToPedidos(String rel) {
        ...
        return Link.of(UriTemplate.of(pedidosUrl,
            pageVariables.concat(filtroVariables)), LinkRelation.of(rel));
    }

    public Link linkToConfirmacaoPedido(UUID codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class)
            .confirmar(codigoPedido)).withRel(rel);
    }

    public Link linkToEntregaPedido(UUID codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class)
            .entregar(codigoPedido)).withRel(rel);
    }

    public Link linkToCancelamentoPedido(UUID codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class)
